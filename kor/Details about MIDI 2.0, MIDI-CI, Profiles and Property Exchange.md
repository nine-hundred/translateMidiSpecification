...
전례없는 수준의 미묘한 음악적, 예술적 표현을 제공하기 위해 MIDI 2.0은 인간의 공연 제스쳐를 컴퓨터가 이해할 수 있는 데이터로 변환하는 미디 관점에서의 퍼포먼스 컨트롤러의 역할을 재해석합니다.
이제 컨트롤러는 사용하기 쉬우며, 각각의 음표를 제어하는 것을 포함한 32,000개 이상의 더 많은 컨트롤러들이 있습니다.
향상된 32비트의 음질은 부드럽고 연속적이며 아날로그의 느낌을 제어할 수 있도록 합니다.
새로운 "Note-On" 옵션은 정밀한 음감과 조음을 제어하기 위해 추가되었습니다.
